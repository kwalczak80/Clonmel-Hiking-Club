...
<ul>
   <li>
      <strong>Returning User Goals</strong>
      <ul>
...
<ul>
   ...
   <ul>
      ...
      <li>I used <a href="https://coolors.co">Coolors</a> to come up with a color scheme and then the <a href="https://contrastchecker.com/">contrast checker</a> to make sure that the contrast is sufficient and there are no issues with website readability.</li>
...
<ul>
   ...
   <ul>
      ...
      <li>The navigation bar is positioned on top of the page at all times to allow the user quickly move between individual sections of the page.</li>
...
<ul>
   ...
   <ul>
      <li>This section allows the user to send a message with their inquiries.</li>
...
<ul>
   <li><strong>First-time user</strong></li>
   <ul>
      <li>As a first-time user, I would like to easily understand what the website is about.</li>
      <ul>
   ...
   <li><strong>Returning User</strong></li>
   <ul>
      <li>As a returning user, I would like to find more information about the club on social media channels.</li>
      <ul>
   ...
   <li><strong>Frequent User</strong></li>
   <ul>
...
# **Content**
<ul>
   <li>The text information in the About Us section was copied from the following websites:</li>
   <ul>
...
<ol type="1">
   ...
   <li>Scroll back down through the page to locate published the <a href="https://kwalczak80.github.io/Clonmel-Hiking-Club/">Clonmel Hiking Club </a>website in the "GitHub Pages" section.</li>
</ol>
<hr>
